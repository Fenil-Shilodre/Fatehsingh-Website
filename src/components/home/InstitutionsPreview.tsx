            ...
            >
              ...
              <div className="p-6 flex-1 flex flex-col justify-between space-y-4">
                <div>
                  ...
                  <div className="text-xs text-orange-700 font-medium mb-3 flex items-center gap-1">
                    <GraduationCap className="w-4 h-4 shrink-0 text-orange-600" />
                ...
                <div className="pt-4 border-t border-sandstone">
                  <a
                    ...
                    className="w-full inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded bg-orange-50 hover:bg-orange-600 text-orange-700 hover:text-white border border-orange-200 hover:border-orange-600 transition-all text-xs font-bold tracking-wider uppercase shadow-sm"
                  >
