  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        ...
        "serif-display": ["'Cormorant Garamond'", "'Noto Serif Gujarati'", "Georgia", "serif"],
        sans: ["'Inter'", "-apple-system", "BlinkMacSystemFont", "sans-serif"],
        hindi: ["'Noto Serif Devanagari'", "'Cormorant Garamond'", "serif"],
        "hindi-sans": ["'Noto Sans Devanagari'", "'Inter'", "sans-serif"],
        gujarati: ["'Noto Serif Gujarati'", "'Cormorant Garamond'", "serif"],
        "gujarati-sans": ["'Noto Sans Gujarati'", "'Inter'", "sans-serif"],
      },
      boxShadow: {
